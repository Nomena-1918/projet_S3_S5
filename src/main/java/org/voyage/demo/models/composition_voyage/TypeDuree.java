...
public class TypeDuree {
    ...
    public TypeDuree(Integer id, String nom) {
        this.id = id;
        this.nom = nom;
    }
    ...
    public TypeDuree(Integer id) {
        this.id = id;
    }

    public TypeDuree(Integer id, String nom, int debutJour, int finJour) {
        this.id = id;
        this.nom = nom;
        this.debutJour = debutJour;
        this.finJour = finJour;
        ...
        try (PreparedStatement statement = connection.prepareStatement(query)) {
            ...
            try (ResultSet resultSet = statement.executeQuery()) {
                while (resultSet.next()) {
                    ...
                    typeDuree.setId(resultSet.getInt("id"));
