...
<div class="container-fluid">
  <main class="tm-main">
    ...
    <div class="row tm-row">
      <div class="col-12">
        <h2 class="tm-color-primary tm-post-title tm-mb-60">Ajout Type Duree</h2>
      </div>
      <div class="col-lg-7 tm-contact-left">
        <form method="POST" action="" class="mb-5 ml-auto mr-0 tm-contact-form">
          ...
          <div class="form-group row mb-4">
            <label for="debut" class="col-sm-3 col-form-label text-right tm-color-primary">Debut jour</label>
            <div class="col-sm-9">
              <input class="form-control mr-0 ml-auto" name="debutJour" id="debut" type="number" required>
            </div>
          </div>
          <div class="form-group row mb-4">
            <label for="fin" class="col-sm-3 col-form-label text-right tm-color-primary">Fin jour</label>
            <div class="col-sm-9">
