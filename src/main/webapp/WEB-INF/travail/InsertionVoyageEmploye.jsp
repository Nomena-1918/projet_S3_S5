      ...
      <div class="col-lg-7 tm-contact-left">
        <form method="POST" action="" class="mb-5 ml-auto mr-0 tm-contact-form">
          <div class="form-group row mb-4">
            <label for="bouquet" class="col-sm-3 col-form-label text-right tm-color-primary">Voyage</label>
            <div class="col-sm-9">
              <select class="form-control mr-0 ml-auto" name="idBouquet" id="bouquet" required>
<%--                <% for (Bouquet value : bouquet) {%>--%>
                <option
<%--                        value="<%=value.getId()%>"><%=value.getNom()%>--%>
                </option>
<%--                <% }%>--%>
              </select>
            </div>
          ...
          <div class="form-group row mb-4">
            <label for="categorieLieu" class="col-sm-3 col-form-label text-right tm-color-primary">Employé :</label>
            <div class="col-sm-9">
              <select class="form-control mr-0 ml-auto" name="idCategorieLieu" id="CategorieLieu" required>
                <% for
<%--                (CategorieLieu item : categorieLieu) {%>--%>
                <option
